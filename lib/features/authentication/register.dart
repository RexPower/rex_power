...
import 'package:rexpower/controllers/auth_controller.dart';
import 'package:rexpower/controllers/loading_controller.dart';
import 'package:rexpower/utilities/route_path.dart';
import 'package:rexpower/utilities/show_error_snackbar.dart';
                                ...
                                AuthController()
                                    .register(
                                        ...
                                        _phoneNumberController.value.text
                                            .trim(),
                                        _firstAndNameController.value.text
                                            .trim())
                                    .then((value) {
                                  if (value) {
